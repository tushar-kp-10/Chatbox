...
const ChatListScreen = ({ navigation }) => {
  ...
  //     time: "12:45 PM",
  //     avatar:
  //       "https://i.pinimg.com/736x/87/69/f8/8769f869b449f860ec1602e2d9c4a524.jpg",
  //   },
  //   {
  //     id: "2",
  //     name: "LavKush",
  //     message: "Chai pio biscuit khaoo",
  //     time: "11:30 AM",
  //     avatar:
  //       "https://static.wikia.nocookie.net/taarakmehta/images/1/16/D37C4A6A-44EE-4C42-B618-76A4A07030DD.jpeg/revision/latest?cb=20220404185912",
  //   },
  //   {
  //     id: "3",
  //     name: "AntriX",
  ...
  //     id: "4",
  //     name: "Messi",
  //     message: "Thanks Grandma",
  //     time: "09:15 AM",
  //     avatar:
  //       "https://wallpaperbat.com/img/116287-lionel-messi-argentina-captain-wallpaper-hd-desktop-and-mobile.jpg",
  //   },
  //   {
  //     id: "5",
  //     name: "Messi",
  ...
  const getUser = useCallback(async () => {
    try {
      const response = await axios.get(
        `http://192.168.29.155:3000/user/${userId}`
      );
